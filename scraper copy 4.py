...
def main():
    ...
    # Setup Session (Cloudscraper to bypass Cloudflare)
    # create_scraper() creates a session that can solve Cloudflare challenges
    session = cloudscraper.create_scraper()
    
    # We can still keep our headers, but cloudscraper manages a lot itself.
    headers = {
